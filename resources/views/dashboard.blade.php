                        ...
                        <table class="min-w-full text-sm">
                            <thead class="bg-orange-50 dark:bg-orange-900/20">
                                <tr class="text-left text-orange-800 dark:text-orange-200">
                                    ...
                                    <th class="px-4 py-2 font-medium">Guest</th>
                                ...
                                @foreach($unscheduledCheckouts as $checkout)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 text-orange-800 dark:text-orange-200">
                                            {{ $checkout['guest_name'] }}
                                            @if(!empty($checkout['source']))
                                                <span class="block text-[10px] text-orange-600/70 dark:text-orange-400/70 italic">{{ $checkout['source'] }}</span>
                                            @endif
                                        </td>
